...
var swalElement = document.querySelector('#swal-fire');
swalElement.onclick = function(){
    // Swal.fire('Thông Báo!','Chúng tôi đang phát triển','warning');
    console.log(swalElement)
}